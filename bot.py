...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("Join Telegram Channel", url="https://t.me/snowdexlab")],  # Replace with your channel URL
        [InlineKeyboardButton("Follow on X", url="https://x.com/SnowDex_org?t=T3Ic3PV2OdOIqP6XivhMcg&s=09")]  # Replace with your Twitter URL
    ]
